...
interface WebApiInterface {
    ...
    @POST()
    suspend fun placeOrder(@Body placeOrderRequest: PlaceOrderRequest, @Header(X_FORWARD_PROXY_ACTION) proxyAction: String,@Url url: String): Response<PlaceOrderResponse>
